...
headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) '
                         'Chrome/103.0.5060.134 Safari/537.36 OPR/89.0.4447.71 (Edition Yx 05)'}
#
...
#
#
# создаем json файл со словарем "категория": "ссылка"
...
# заменяет все символы в названии на _
...
for category_name, category_href in all_categories.items():
    ...
    soup = BeautifulSoup(src, 'lxml')
    # проверка на наличие таблицы с продуктами
    alert_block = soup.find(class_="uk-alert-danger")
    if alert_block is not None:
        continue

    # собираем заголовки табицы
